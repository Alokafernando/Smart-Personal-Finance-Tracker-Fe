    ...
    <div className="min-h-screen w-full bg-[#0d0f1a] text-white relative">
      <header className="w-full fixed top-0 left-0 z-50 bg-[#0d0f1a]/80 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a href="/login" className="px-5 py-2 bg-blue-600 rounded-xl font-semibold hover:bg-blue-700 transition" >
            Login
          </a>
        </div>
      </header>
        ...
        <div className="relative z-10 max-w-7xl w-full flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex-1 flex flex-col justify-center ml-6 md:ml-12">
            ...
            <div className="flex items-center gap-4 mt-8">
              <a href="/login" className="px-6 py-3 bg-blue-600/80 rounded-xl font-semibold hover:bg-blue-700/90 transition shadow-lg">
                Get Started
              </a>

              <a href="/login" className="px-6 py-3 bg-[#1a1a1a] rounded-xl font-semibold hover:bg-gray-700 transition shadow">
                Login
              </a>
            </div>
          </div>
          ...
          <div className="flex-1 flex justify-end items-start relative">
            <img src={image} alt="AI Generated Illustration" className="w-[300px] md:w-[400px] lg:w-[500px] object-contain rounded-l-3xl shadow-2xl -translate-y-8 translate-x-20 border-t border-l border-b border-gray-500"/>
          </div>
