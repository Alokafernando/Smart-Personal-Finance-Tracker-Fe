      ...
      <div className="relative z-10 p-6 md:p-8">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-1">Rs {totals.totalIncome.toLocaleString()}</h2>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-1">Rs {totals.totalExpense.toLocaleString()}</h2>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group">
            ...
            <h2 className="text-2xl font-bold text-white mt-1">Rs {totals.balance.toLocaleString()}</h2>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-1">{totals.savingsRate}%</h2>
          </div>
        </section>
