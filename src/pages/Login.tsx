...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0d0f1a] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#141726]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-[0_0_40px_-10px_rgba(0,0,0,0.6)] transition hover:shadow-[0_0_60px_-10px_rgba(0,0,0,0.8)]">
